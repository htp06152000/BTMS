...
<div class="row justify-content-center vh-100">
    <div class="login text-center text-light shadow-sm animate__animated animate__<?=(isset($_SESSION['message'])?'swing':'bounceInDown')?>" method="post"  style="margin-top: 110px; width: 275px">
